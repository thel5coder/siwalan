...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2017 at 07:29 PM
...
CREATE TABLE `bpjs_kesehatan` (
  ...
  `mulai_menjadi_peserta` date NOT NULL,
  `nomor_pendaftaran` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `jumlah_peserta_tenaga_kerja` int(11) NOT NULL,
  `jumlah_peserta_keluarga` int(11) NOT NULL,
  `jaminan_pemeliharaan_kesehatan` enum('A','B','C') COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `bpjs_kesehatan` (`id`, `lapor_id`, `mulai_menjadi_peserta`, `nomor_pendaftaran`, `jumlah_peserta_tenaga_kerja`, `jumlah_peserta_keluarga`, `jaminan_pemeliharaan_kesehatan`, `created_at`, `updated_at`) VALUES
(1, 1, '2009-08-08', '1234', 20, 40, 'B', '2017-08-31 08:34:31', '2017-08-31 08:36:03');
...
CREATE TABLE `bpjs_ketenagakerjaan` (
  ...
  `jaminan_kecelakaan_kerja` enum('A','B','C') COLLATE utf8_unicode_ci NOT NULL,
  `jaminan_kematian` enum('A','B','C') COLLATE utf8_unicode_ci NOT NULL,
  `jaminan_hari_tua` enum('A','B','C') COLLATE utf8_unicode_ci NOT NULL,
  `jaminan_pensiun` enum('A','B','C') COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `bpjs_ketenagakerjaan` (`id`, `lapor_id`, `mulai_menjadi_peserta`, `nomor_pendaftaran`, `jumlah_peserta`, `jaminan_kecelakaan_kerja`, `jaminan_kematian`, `jaminan_hari_tua`, `jaminan_pensiun`, `created_at`, `updated_at`) VALUES
(1, 1, '2008-12-27', '4423434', 20, 'B', 'A', 'A', 'A', '2017-08-31 07:12:44', '2017-08-31 07:31:03');

-- --------------------------------------------------------

--
-- Table structure for table `fasilitas_k3`
--

CREATE TABLE `fasilitas_k3` (
  `id` int(10) UNSIGNED NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `fasilitas_k3_id` int(11) NOT NULL,
...
--
-- Dumping data for table `fasilitas_k3`
--

INSERT INTO `fasilitas_k3` (`id`, `lapor_id`, `fasilitas_k3_id`, `jumlah`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 0, '2017-08-31 03:10:47', '2017-08-31 03:10:47'),
(3, 1, 4, 0, '2017-08-31 03:36:32', '2017-08-31 03:36:32'),
(6, 1, 2, 3, '2017-08-31 03:47:46', '2017-08-31 04:10:23');

-- --------------------------------------------------------

--
-- Table structure for table `fasilitas_kesejahteraan`
--

CREATE TABLE `fasilitas_kesejahteraan` (
  `id` int(10) UNSIGNED NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `fasilitas_kesejahteraan_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `fasilitas_kesejahteraan`
--

INSERT INTO `fasilitas_kesejahteraan` (`id`, `lapor_id`, `fasilitas_kesejahteraan_id`, `created_at`, `updated_at`) VALUES
(4, 1, 1, '2017-08-31 05:10:16', '2017-08-31 05:10:16'),
(5, 1, 7, '2017-08-31 05:10:16', '2017-08-31 05:10:16');

-- --------------------------------------------------------

--
-- Table structure for table `group_korwil`
--

CREATE TABLE `group_korwil` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `group_korwil`
--

INSERT INTO `group_korwil` (`id`, `kabupaten_id`, `korwil_id`, `created_at`, `updated_at`) VALUES
(1, 3578, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 3515, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, 3525, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, 3516, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(7, 3576, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(8, 3575, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(9, 3507, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(10, 3573, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11, 3579, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(12, 3504, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(13, 3503, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(14, 3505, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(15, 3572, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(16, 3519, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(17, 3577, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(18, 3506, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(19, 3571, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(20, 3520, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(21, 3521, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(22, 3502, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(23, 3501, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(24, 3522, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(25, 3523, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(26, 3524, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(27, 3517, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(28, 3518, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(29, 3509, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(30, 3510, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(31, 3512, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(32, 3511, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(33, 3508, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(34, 3513, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(35, 3526, 6, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(36, 3527, 6, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(37, 3528, 6, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(38, 3529, 6, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `instalasi_limbah_amdal`
--

CREATE TABLE `instalasi_limbah_amdal` (
  `id` int(10) UNSIGNED NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `instalasi_limbah` tinyint(1) NOT NULL DEFAULT '0',
  `amdal` tinyint(1) NOT NULL DEFAULT '0',
  `no_sertifikat` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `instalasi_limbah_amdal`
--

INSERT INTO `instalasi_limbah_amdal` (`id`, `lapor_id`, `instalasi_limbah`, `amdal`, `no_sertifikat`, `tgl_sertifikat`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, '34234234234', '2009-01-05', '2017-08-30 19:29:18', '2017-08-30 19:29:18');
...
CREATE TABLE `kabupaten` (
  ...
  `id_prov` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `kabupaten` (`id`, `id_prov`, `nama_kabupaten`) VALUES
...
CREATE TABLE `kecamatan` (
  `id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `id_kabkota` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `kecamatan` (`id`, `id_kabkota`, `nama_kecamatan`) VALUES
...
INSERT INTO `kepemilikan` (`id`, `perusahaan_id`, `nama_pemilik`, `alamat_pemilik`, `created_at`, `updated_at`) VALUES
(2, 8, 'Syaikhul Hadi', 'Mojokerto', '2017-08-22 15:36:13', '2017-08-22 15:36:13'),
(4, 8, 'Vidi Pandu Pratama', 'Mojokerto', '2017-08-22 15:49:13', '2017-08-22 15:49:28');

-- --------------------------------------------------------

--
-- Table structure for table `ketenagakerjaan_waktu_kerja`
--

CREATE TABLE `ketenagakerjaan_waktu_kerja` (
  `id` int(10) UNSIGNED NOT NULL,
  `perusahaan_id` int(11) NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `waktu_kerja_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ketenagakerjaan_waktu_kerja`
--

INSERT INTO `ketenagakerjaan_waktu_kerja` (`id`, `perusahaan_id`, `lapor_id`, `waktu_kerja_id`, `created_at`, `updated_at`) VALUES
(4, 8, 1, 1, '2017-08-30 09:19:15', '2017-08-30 09:19:15'),
(5, 8, 1, 2, '2017-08-30 09:19:15', '2017-08-30 09:19:15'),
(6, 8, 1, 5, '2017-08-30 09:19:15', '2017-08-30 09:19:15');

-- --------------------------------------------------------

--
-- Table structure for table `limbah_produksi`
--

CREATE TABLE `limbah_produksi` (
  `id` int(10) UNSIGNED NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `jenis_limbah_produksi` enum('Padat','Cair','Gas') COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `limbah_produksi`
--

INSERT INTO `limbah_produksi` (`id`, `lapor_id`, `jenis_limbah_produksi`, `created_at`, `updated_at`) VALUES
(6, 1, 'Padat', '2017-08-30 18:53:52', '2017-08-30 18:53:52'),
(7, 1, 'Gas', '2017-08-30 18:53:52', '2017-08-30 18:53:52');

-- --------------------------------------------------------

--
-- Table structure for table `master_alat_bahan`
--

CREATE TABLE `master_alat_bahan` (
  `id` int(10) UNSIGNED NOT NULL,
  `nama_alat_bahan` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `master_alat_bahan`
--

INSERT INTO `master_alat_bahan` (`id`, `nama_alat_bahan`, `created_at`, `updated_at`) VALUES
(1, 'Ketel Uap', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 'Bejana Uap', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, 'Instalasi Pemadam Kebakaran', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 'Bahan Radio Aktif', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, 'Perancah', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, 'Pesawat Angkat-Angkut', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(7, 'Penyalur Petir', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(8, 'Pembangkit Listrik', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(9, 'Pesawat Tenaga dan Produksi', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(10, 'Lift', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11, 'Turbine', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(12, 'Bejana Tekanan', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(13, 'Motor Listrik', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(14, 'Instalasi Listrik', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(15, 'Saran Proteksi Kebakaran', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(16, 'Bejana Beracun dan Berbahaya', '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `master_fasilitas_k3`
--

CREATE TABLE `master_fasilitas_k3` (
  `id` int(10) UNSIGNED NOT NULL,
  `nama_fasilitas_keselamatan` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `is_ammount` tinyint(1) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `master_fasilitas_k3`
--

INSERT INTO `master_fasilitas_k3` (`id`, `nama_fasilitas_keselamatan`, `is_ammount`, `created_at`, `updated_at`) VALUES
(1, 'P3K', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 'Dokter Pemeriksa', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, 'Paramedis', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 'Poliklinik', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, 'Ahli Petugas K3', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, 'Regu Pemadam Kebakaran', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `master_fasilitas_kesejahteraan`
--

CREATE TABLE `master_fasilitas_kesejahteraan` (
  `id` int(10) UNSIGNED NOT NULL,
  `nama_fasilitas_kesejahteraan` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `master_fasilitas_kesejahteraan`
--

INSERT INTO `master_fasilitas_kesejahteraan` (`id`, `nama_fasilitas_kesejahteraan`, `created_at`, `updated_at`) VALUES
(1, 'Koperasi Karyawan', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 'Sarana Ibadah', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, 'Olahraga dan Kesenian', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 'TPA', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, 'Unit KB Perusahaan', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, 'Perumahan Karyawan', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(7, 'kantin', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE `master_jenis_usaha` (
  `id` int(10) UNSIGNED NOT NULL,
  `kode_jenis_usaha` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `nama_jenis_usaha` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `master_jenis_usaha` (`id`, `kode_jenis_usaha`, `nama_jenis_usaha`, `created_at`, `updated_at`) VALUES
(1, '1', 'Pertanian, Kehutanan,dan Perikanan', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, '2', 'Pertambangan dan Penggalian', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, '3', 'Industri Pengolahan', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, '4', 'Pengadaan Listrik,Gas,Uap/Air Panas dan Udara Dingin', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, '5', 'Pengadaan Listrik,Gas,Uap/Air Panas dan Udara Dingin', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, '6', 'Konstruksi', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(7, '7', 'Perdagangan Besar dan Eceran, Reparasi dan Perawatan Mobil', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(8, '8', 'Transportasi dan Pergudangan', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(9, '9', 'Penyediaan Akomodasi dan Penyediaan Makan Minum', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(10, '10', 'Informasi dan Komunikasi', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11, '11', 'Jasa Keungan dan Asuransi', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(12, '12', 'Real Estat', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(13, '13', 'Jasa Profesional, Ilmiah dan Teknis', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(14, '14', 'Jasa Persewaan Ketenagakerjaan, Agen Perjalanan dan Penunjangan Usaha Lainnya', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(15, '15', 'Administrasi Pemerintahan, Pertahanan dan Jaminan Sosial Wajib', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(16, '16', 'Jasa Pendidikan', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(17, '17', 'Jasa Kesehatan dan Kegiatan Sosial', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(18, '18', 'Kebudayaan,Hiburan, dan Rekreasi', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(19, '19', 'Kegiatan Jasa Lainnya', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(20, '20', 'Jasa Perorangan Yang Melayani Rumah Tangga;Kegiatan Yang Menghasilkan', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(21, '21', 'Kegiatan Badan Internasional dan Badang Ekstra Internasional Lainnya', '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `master_korwil`
--

CREATE TABLE `master_korwil` (
  `id` int(10) UNSIGNED NOT NULL,
  `kode_korwil` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `nama_korwil` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `master_korwil`
--

INSERT INTO `master_korwil` (`id`, `kode_korwil`, `nama_korwil`, `created_at`, `updated_at`) VALUES
(1, '01', 'Korwil I', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, '02', 'Korwil II', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, '03', 'Korwil III', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, '04', 'Korwil IV', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, '05', 'Korwil V', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, '06', 'Korwil VI', '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `master_waktu_kerja`
--

CREATE TABLE `master_waktu_kerja` (
  `id` int(10) UNSIGNED NOT NULL,
  `nama_waktu_kerja` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `master_waktu_kerja`
--

INSERT INTO `master_waktu_kerja` (`id`, `nama_waktu_kerja`, `created_at`, `updated_at`) VALUES
(1, '7 Jam /hari dan 40 Jam/minggu', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, '8 Jam /hari dan 40 Jam/minggu', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, '12 Jam/hari dan 40 Jam/minggu', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, '12 jam/hari selama 10 hari terus menerus', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(8, '12 jam/hari selama 14 hari terus menerus', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(9, 'Lebih lama dari 7 atau 8 jam/hari dan 40/jam minggu kurang dari 12 jam per hari 10 hari terus menerus', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(10, 'Kurang atau sama dengan 24 jam/minggu', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11, 'kurang atau sama dengan 20 jam/minggu', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
('2017_08_17_224812_create_table_ketenagakerjaan_umum', 2),
('2017_08_17_230056_create_table_waktu_kerja', 3),
('2017_08_17_230147_create_table_master_waktu_kerja', 3),
('2017_08_22_132321_create_table_master_jenis_usaha', 4),
('2017_08_22_142842_create_table_master_korwil', 5),
('2017_08_22_143037_create_table_group_korwil', 5),
('2017_08_22_143528_create_table_kepemilikan', 5),
('2017_08_22_143808_create_table_master_fasilitas_keselamatan_kesehatan_kerja', 5),
('2017_08_22_143851_create_table_group_fasilitas_keselamatan_kesehatan_kerja', 5),
('2017_08_22_144445_create_table_limbah_produksi', 5),
('2017_08_22_225529_create_table_wajib_lapor', 6),
('2017_08_30_162236_create_table_penggunaan_alat_bahan', 7),
('2017_08_30_163231_create_table_master_alat_bahan', 7),
('2017_08_31_020022_create_table_instalasi_limbah_amdal', 8),
('2017_08_31_023843_create_table_pengupahan', 9),
('2017_08_31_063108_create_table_master_fasilitas_kesejahteraan', 10),
('2017_08_31_063154_create_table_fasilitas_keselamatan_kesehatan_kerja', 10),
('2017_08_31_063717_create_table_fasilitas_kesejahteraan', 11),
('2017_08_31_122307_create_table_bpjs_ketenagakerjaan', 12),
('2017_08_31_143554_create_table_bpjs_kesehatan', 13),
('2017_08_31_154607_create_table_program_pensiun', 14),
('2017_08_31_161302_create_table_perangkat_hubungan_kerja', 15);
...
--
-- Table structure for table `penggunaan_alat_bahan`
--

CREATE TABLE `penggunaan_alat_bahan` (
  `id` int(10) UNSIGNED NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `alat_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sub_alat` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `penggunaan_alat_bahan`
--

INSERT INTO `penggunaan_alat_bahan` (`id`, `lapor_id`, `alat_id`, `sub_alat`, `jumlah`, `created_at`, `updated_at`) VALUES
(1, 1, '1', '', 1, '2017-08-30 17:03:00', '2017-08-30 17:34:23'),
(2, 1, '2', '', 1, '2017-08-30 17:03:28', '2017-08-30 17:34:49'),
(3, 1, '3', 'APAR', 2, '2017-08-30 17:05:16', '2017-08-30 17:33:35');
...
CREATE TABLE `pengupahan` (
  `id` int(10) UNSIGNED NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `jumlah_upah_pekerja_dibayarkan` bigint(20) NOT NULL,
  `tingkat_upah_tertinggi` bigint(20) NOT NULL,
  `tingkat_upah_terendah` bigint(20) NOT NULL,
  `jumlah_penerima_umk_ump_umsk` int(11) NOT NULL,
  `jumlah_penerima_umk_ump_umsk_dalam_persen` int(11) NOT NULL,
  `tunjangan_hari_raya_keagamaan` enum('1 bulan upah','>1 bulan upah') COLLATE utf8_unicode_ci NOT NULL,
  `bonus_gratifikasi` enum('1 bulan gaji','>1 bulan gaji','<1 bulan gaji') COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `pengupahan` (`id`, `lapor_id`, `jumlah_upah_pekerja_dibayarkan`, `tingkat_upah_tertinggi`, `tingkat_upah_terendah`, `jumlah_penerima_umk_ump_umsk`, `jumlah_penerima_umk_ump_umsk_dalam_persen`, `tunjangan_hari_raya_keagamaan`, `bonus_gratifikasi`, `created_at`, `updated_at`) VALUES
(1, 1, 100000000, 10000000, 5000000, 20, 50, '>1 bulan upah', '<1 bulan gaji', '2017-08-30 23:15:53', '2017-08-30 23:24:48');

-- --------------------------------------------------------

--
-- Table structure for table `perangkat_hubungan_kerja`
--

CREATE TABLE `perangkat_hubungan_kerja` (
  `id` int(10) UNSIGNED NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `pk` tinyint(1) NOT NULL DEFAULT '0',
  `pp` tinyint(1) NOT NULL DEFAULT '0',
  `kkb` tinyint(1) NOT NULL DEFAULT '0',
  `tgl_pengesahan_pk_kkb` date DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `program_pensiun`
--

CREATE TABLE `program_pensiun` (
  `id` int(10) UNSIGNED NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `jenis_program_pensiun` enum('1','2') COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `program_pensiun`
--

INSERT INTO `program_pensiun` (`id`, `lapor_id`, `jenis_program_pensiun`, `created_at`, `updated_at`) VALUES
(1, 1, '2', '2017-08-31 09:01:38', '2017-08-31 09:06:12');
...
CREATE TABLE `umum` (
  ...
  `perusahaan_id` int(11) NOT NULL,
  `lapor_id` int(11) NOT NULL,
  `jml_cpuh_tetap_wni_laki_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tetap_wni_laki_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tetap_wni_laki_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tetap_wni_laki_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tetap_wni_laki_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tetap_wni_laki_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tetap_wni_laki_kurang_dari_15` int(11) DEFAULT '0',
  `jml_cpubr_tetap_wni_laki_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tetap_wni_laki_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tetap_wni_wanita_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tetap_wni_wanita_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tetap_wni_wanita_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tetap_wni_wanita_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tetap_wni_wanita_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tetap_wni_wanita_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tetap_wni_wanita_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tetap_wni_wanita_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tetap_wni_wanita_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tidaktetap_wni_laki_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tidaktetap_wni_laki_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tidaktetap_wni_laki_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tidaktetap_wni_laki_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tidaktetap_wni_laki_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tidaktetap_wni_laki_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tidaktetap_wni_laki_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tidaktetap_wni_laki_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tidaktetap_wni_laki_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tidaktetap_wni_wanita_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tidaktetap_wni_wanita_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tidaktetap_wni_wanita_lebih_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tidaktetap_wni_wanita_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tidaktetap_wni_wanita_kurang_dari_18` int(11) DEFAULT '0',
  `jml_cpubl_tidaktetap_wni_wanita_kurang_dari_18` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tidaktetap_wni_wanita_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tidaktetap_wni_wanita_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tidaktetap_wni_wanita_kurang_dari_15` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tetap_wna_laki` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tetap_wna_laki` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tetap_wna_laki` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tidaktetap_wna_laki` int(11) NOT NULL DEFAULT '0',
  `jml_cpubr_tidaktetap_wna_laki` int(11) NOT NULL DEFAULT '0',
  `jml_cpubl_tidaktetap_wna_laki` int(11) NOT NULL DEFAULT '0',
  `jml_cpuh_tetap_wna_wanita` int(11) DEFAULT '0',
  `jml_cpubr_tetap_wna_wanita` int(11) DEFAULT '0',
  `jml_cpubl_tetap_wna_wanita` int(11) DEFAULT '0',
  `jml_cpuh_tidaktetap_wna_wanita` int(11) DEFAULT '0',
  `jml_cpubr_tidaktetap_wna_wanita` int(11) DEFAULT '0',
  `jml_cpubl_tidaktetap_wna_wanita` int(11) DEFAULT '0',
  `jml_tenaga_kerja_tetap_cpuh` int(11) DEFAULT '0',
  `jml_tenaga_kerja_tetap_cpubr` int(11) DEFAULT '0',
  `jml_tenaga_kerja_tetap_cpubl` int(11) DEFAULT '0',
  `jml_tenaga_kerja_tidak_tetap_cpuh` int(11) DEFAULT '0',
  `jml_tenaga_kerja_tidak_tetap_cpubr` int(11) DEFAULT '0',
  `jml_tenaga_kerja_tidak_tetap_cpubl` int(11) DEFAULT '0',
  `jml_wni_laki_lebih_dari_18` int(11) DEFAULT '0',
  `jml_wni_laki_kurang_dari_18` int(11) DEFAULT '0',
  `jml_wni_laki_kurang_dari_15` int(11) DEFAULT '0',
  `jml_wni_wanita_lebih_dari_18` int(11) DEFAULT '0',
  `jml_wni_wanita_kurang_dari_18` int(11) DEFAULT '0',
  `jml_wni_wanita_kurang_dari_15` int(11) DEFAULT '0',
  `jml_wna_laki` int(11) DEFAULT '0',
  `jml_wna_wanita` int(11) DEFAULT '0',
  `total_pekerja` int(11) DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `umum` (`id`, `perusahaan_id`, `lapor_id`, `jml_cpuh_tetap_wni_laki_lebih_dari_18`, `jml_cpubr_tetap_wni_laki_lebih_dari_18`, `jml_cpubl_tetap_wni_laki_lebih_dari_18`, `jml_cpuh_tetap_wni_laki_kurang_dari_18`, `jml_cpubr_tetap_wni_laki_kurang_dari_18`, `jml_cpubl_tetap_wni_laki_kurang_dari_18`, `jml_cpuh_tetap_wni_laki_kurang_dari_15`, `jml_cpubr_tetap_wni_laki_kurang_dari_15`, `jml_cpubl_tetap_wni_laki_kurang_dari_15`, `jml_cpuh_tetap_wni_wanita_lebih_dari_18`, `jml_cpubr_tetap_wni_wanita_lebih_dari_18`, `jml_cpubl_tetap_wni_wanita_lebih_dari_18`, `jml_cpuh_tetap_wni_wanita_kurang_dari_18`, `jml_cpubr_tetap_wni_wanita_kurang_dari_18`, `jml_cpubl_tetap_wni_wanita_kurang_dari_18`, `jml_cpuh_tetap_wni_wanita_kurang_dari_15`, `jml_cpubr_tetap_wni_wanita_kurang_dari_15`, `jml_cpubl_tetap_wni_wanita_kurang_dari_15`, `jml_cpuh_tidaktetap_wni_laki_lebih_dari_18`, `jml_cpubr_tidaktetap_wni_laki_lebih_dari_18`, `jml_cpubl_tidaktetap_wni_laki_lebih_dari_18`, `jml_cpuh_tidaktetap_wni_laki_kurang_dari_18`, `jml_cpubr_tidaktetap_wni_laki_kurang_dari_18`, `jml_cpubl_tidaktetap_wni_laki_kurang_dari_18`, `jml_cpuh_tidaktetap_wni_laki_kurang_dari_15`, `jml_cpubr_tidaktetap_wni_laki_kurang_dari_15`, `jml_cpubl_tidaktetap_wni_laki_kurang_dari_15`, `jml_cpuh_tidaktetap_wni_wanita_lebih_dari_18`, `jml_cpubr_tidaktetap_wni_wanita_lebih_dari_18`, `jml_cpubl_tidaktetap_wni_wanita_lebih_dari_18`, `jml_cpuh_tidaktetap_wni_wanita_kurang_dari_18`, `jml_cpubr_tidaktetap_wni_wanita_kurang_dari_18`, `jml_cpubl_tidaktetap_wni_wanita_kurang_dari_18`, `jml_cpuh_tidaktetap_wni_wanita_kurang_dari_15`, `jml_cpubr_tidaktetap_wni_wanita_kurang_dari_15`, `jml_cpubl_tidaktetap_wni_wanita_kurang_dari_15`, `jml_cpuh_tetap_wna_laki`, `jml_cpubr_tetap_wna_laki`, `jml_cpubl_tetap_wna_laki`, `jml_cpuh_tidaktetap_wna_laki`, `jml_cpubr_tidaktetap_wna_laki`, `jml_cpubl_tidaktetap_wna_laki`, `jml_cpuh_tetap_wna_wanita`, `jml_cpubr_tetap_wna_wanita`, `jml_cpubl_tetap_wna_wanita`, `jml_cpuh_tidaktetap_wna_wanita`, `jml_cpubr_tidaktetap_wna_wanita`, `jml_cpubl_tidaktetap_wna_wanita`, `jml_tenaga_kerja_tetap_cpuh`, `jml_tenaga_kerja_tetap_cpubr`, `jml_tenaga_kerja_tetap_cpubl`, `jml_tenaga_kerja_tidak_tetap_cpuh`, `jml_tenaga_kerja_tidak_tetap_cpubr`, `jml_tenaga_kerja_tidak_tetap_cpubl`, `jml_wni_laki_lebih_dari_18`, `jml_wni_laki_kurang_dari_18`, `jml_wni_laki_kurang_dari_15`, `jml_wni_wanita_lebih_dari_18`, `jml_wni_wanita_kurang_dari_18`, `jml_wni_wanita_kurang_dari_15`, `jml_wna_laki`, `jml_wna_wanita`, `total_pekerja`, `created_at`, `updated_at`) VALUES
(1, 8, 1, 1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 7, 7, 7, 7, 7, 7, 8, 8, 8, 8, 8, 8, 36, 36, 36, 36, 36, 36, 6, 12, 18, 24, 30, 36, 42, 48, 216, '2017-08-30 07:40:04', '2017-08-30 07:40:04');
...
CREATE TABLE `users` (
  ...
  `user_level` enum('perusahaan','admin dinas') COLLATE utf8_unicode_ci NOT NULL,
  `alamat_perusahaan` text COLLATE utf8_unicode_ci,
  `no_telepon` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `korwil` int(11) NOT NULL,
  `activation_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `is_active` tinyint(1) NOT NULL,
  `jenis_usaha_id` int(11) DEFAULT NULL,
  `produk_akhir` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tanggal_pendirian` date DEFAULT NULL,
  `nomor_akta_pendirian` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tgl_perpindahan_perusahaan` date DEFAULT NULL,
  `alamat_lama` text COLLATE utf8_unicode_ci,
  `status_perusahaan` enum('Pusat','Cabang') COLLATE utf8_unicode_ci DEFAULT NULL,
  `jumlah_cabang_di_indonesia` int(11) DEFAULT NULL,
  `jumlah_cabang_luar_indonesia` int(11) DEFAULT NULL,
  `status_pemilikan` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status_permodalan` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nama_pengelolah` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `alamat_pengelolah` text COLLATE utf8_unicode_ci NOT NULL,
  `logo_perusahaan` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `user_level`, `alamat_perusahaan`, `no_telepon`, `kelurahan`, `kabupaten`, `kode_pos`, `korwil`, `activation_token`, `is_active`, `jenis_usaha_id`, `produk_akhir`, `tanggal_pendirian`, `nomor_akta_pendirian`, `tgl_perpindahan_perusahaan`, `alamat_lama`, `status_perusahaan`, `jumlah_cabang_di_indonesia`, `jumlah_cabang_luar_indonesia`, `status_pemilikan`, `status_permodalan`, `nama_pengelolah`, `alamat_pengelolah`, `logo_perusahaan`, `remember_token`, `created_at`, `updated_at`) VALUES
(8, 'Hasaria', 'my.ant2008@gmail.com', '$2y$10$HpIkKIOiHKHjPIN2dycc1eAdg20TQBIFP27.1GyUxjp1JIBooExcK', 'perusahaan', 'Jln. Jeruk 88', '3424842', '3516100', '3516', '3423', 1, 'd179156b7d48c99746babdac9f6e7299', 1, 10, 'Jasa', '2010-01-02', '328498', '2012-01-07', 'ddfkajdsf', 'Pusat', 3, 3, 'Perseorangan', 'Persero', 'Nero Setiawan', 'Mlaten ', NULL, 'vKKgjEuoZtyFTQZXXDDgD0zzfNTeobLucs8X7jyrS1eVlEJOAUUYiuaZlyPf', '2017-08-17 10:27:28', '2017-08-29 23:57:39');

-- --------------------------------------------------------

--
-- Table structure for table `wajib_lapor`
--

CREATE TABLE `wajib_lapor` (
  `id` int(10) UNSIGNED NOT NULL,
  `perusahaan_id` int(11) NOT NULL,
  `kode_wilayah` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tahun` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `kode_kblui` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `laporan_ke` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tgl_lapor` date NOT NULL,
  `tgl_lapor_selanjutnya` date NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `wajib_lapor`
--

INSERT INTO `wajib_lapor` (`id`, `perusahaan_id`, `kode_wilayah`, `tahun`, `kode_kblui`, `laporan_ke`, `tgl_lapor`, `tgl_lapor_selanjutnya`, `created_at`, `updated_at`) VALUES
(1, 8, '3423', '2017', '10', '1-23-08-2017', '2017-08-23', '2018-08-23', '2017-08-22 19:35:58', '2017-08-22 19:35:58');
...
--
-- Indexes for table `fasilitas_k3`
--
ALTER TABLE `fasilitas_k3`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fasilitas_kesejahteraan`
--
ALTER TABLE `fasilitas_kesejahteraan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `group_korwil`
--
ALTER TABLE `group_korwil`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `instalasi_limbah_amdal`
--
ALTER TABLE `instalasi_limbah_amdal`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ketenagakerjaan_waktu_kerja`
--
ALTER TABLE `ketenagakerjaan_waktu_kerja`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `limbah_produksi`
--
ALTER TABLE `limbah_produksi`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `master_alat_bahan`
--
ALTER TABLE `master_alat_bahan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `master_fasilitas_k3`
--
ALTER TABLE `master_fasilitas_k3`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `master_fasilitas_kesejahteraan`
--
ALTER TABLE `master_fasilitas_kesejahteraan`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `master_korwil`
--
ALTER TABLE `master_korwil`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `master_waktu_kerja`
--
ALTER TABLE `master_waktu_kerja`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `penggunaan_alat_bahan`
--
ALTER TABLE `penggunaan_alat_bahan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pengupahan`
--
ALTER TABLE `pengupahan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `perangkat_hubungan_kerja`
--
ALTER TABLE `perangkat_hubungan_kerja`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `program_pensiun`
--
ALTER TABLE `program_pensiun`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `wajib_lapor`
--
ALTER TABLE `wajib_lapor`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `bpjs_ketenagakerjaan`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `fasilitas_k3`
--
ALTER TABLE `fasilitas_k3`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `fasilitas_kesejahteraan`
--
ALTER TABLE `fasilitas_kesejahteraan`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `group_korwil`
--
ALTER TABLE `group_korwil`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
--
-- AUTO_INCREMENT for table `instalasi_limbah_amdal`
--
ALTER TABLE `instalasi_limbah_amdal`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `ketenagakerjaan_waktu_kerja`
--
ALTER TABLE `ketenagakerjaan_waktu_kerja`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `limbah_produksi`
--
ALTER TABLE `limbah_produksi`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `master_alat_bahan`
--
ALTER TABLE `master_alat_bahan`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `master_fasilitas_k3`
--
ALTER TABLE `master_fasilitas_k3`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `master_fasilitas_kesejahteraan`
--
ALTER TABLE `master_fasilitas_kesejahteraan`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
-- AUTO_INCREMENT for table `master_korwil`
--
ALTER TABLE `master_korwil`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `master_waktu_kerja`
--
ALTER TABLE `master_waktu_kerja`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `penggunaan_alat_bahan`
--
ALTER TABLE `penggunaan_alat_bahan`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `pengupahan`
--
ALTER TABLE `pengupahan`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `perangkat_hubungan_kerja`
--
ALTER TABLE `perangkat_hubungan_kerja`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `program_pensiun`
--
ALTER TABLE `program_pensiun`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `wajib_lapor`
--
ALTER TABLE `wajib_lapor`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
