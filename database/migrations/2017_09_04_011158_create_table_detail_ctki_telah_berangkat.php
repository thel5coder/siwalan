...
class CreateTableDetailCtkiTelahBerangkat extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detail_ctki_telah_berangkat', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('detail_ctki_telah_berangkat');
    }
}
